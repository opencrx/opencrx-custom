package org.opencrx.sample.test;
...
public class SampleOpenCrxClient {
	...
	public static void main(
		...
		String connectionUrl = "http://127.0.0.1:7180/opencrx-rest-CRX/";
		...
		PersistenceManagerFactory pmf = org.opencrx.kernel.utils.Utils.getPersistenceManagerFactoryProxy(
			...
			userName,
			password,
			"application/json" // or 'text/xml' for plain xml protocol, application/vnd.openmdx.wbxml
		);
